...
import "./asrs_page.styles.css";

import AsrsQues from "../../data/asrs_questions";
import Ans from "../../data/answer";
import { useHistory, useLocation } from "react-router-dom";
import SelfPage from "../self_page/self_page.component";
  ...
  return (
    <div className="asrs_page">
      ...
      <div className="box">
        ...
        <button
          type="button"
          className="btn btn-dark buttt_asrs"
